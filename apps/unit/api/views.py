...
class UnitListCreateAPIView(BasicQueryParamsFilterMixin, CustomListCreateMixin, generics.ListCreateAPIView):
    permission_classes = [IsAuthenticated, GroupPermission]
    required_permissions = ['view_unit', 'add_unit']
    ...
    def get_queryset(self):
        ...
        return self.filter_queryset(queryset, name='name', short_name='short_name', status='status')

class UnitRetrieveUpdateDestroyAPIView(CustomRetrieveUpdateDestroyMixin, generics.RetrieveUpdateDestroyAPIView):
    permission_classes = [IsAuthenticated, GroupPermission]
    required_permissions = ['change_unit', 'delete_unit']
